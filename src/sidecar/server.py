...
def load_whisper():
    ...
    partial_model_size = os.environ.get("WHISPER_MODEL_PARTIAL", "small")
...
def transcribe():
    ...
    if not model_size:
        model_size = "small" if data.get("is_partial") else os.environ.get("WHISPER_MODEL_FINAL", os.environ.get("WHISPER_MODEL", "large-v3"))
